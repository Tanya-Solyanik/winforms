...
public partial class Form1 : Form
{
    ...
    public void RoundTripCustomFormat_String()
    {
        Clipboard.SetData("MyFormat", "MyData");
        object? value = Clipboard.GetData("MyFormat");
    }

    public void RoundTripCustomFormat_Array()
    {
        int[][] jagged =
        [
            [1, 2, 3, 4],
    ...
    public void RoundTripCustomFormat_OffsetArray()
    {
    ...
    public void RoundTripCustomFormat_Primitive()
    {
    ...
    public void RoundTripCustomFormat_GenericList()
    {
    ...
    public void RoundTripCustomFormat_Known()
    {
