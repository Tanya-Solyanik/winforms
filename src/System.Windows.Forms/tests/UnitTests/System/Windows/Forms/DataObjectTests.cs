...
public partial class DataObjectTests
{
    ...
    public static TheoryData<string> GetData_String_TheoryData()
    {
        TheoryData<string> theoryData = [];
        foreach (string item in s_restrictedClipboardFormats)
        {
            theoryData.Add(item);
        }
    ...
    public static TheoryData<string> GetData_String_UnboundedFormat_TheoryData()
    {
        TheoryData<string> theoryData = [];
        foreach (string item in s_unboundedClipboardFormats)
        {
            theoryData.Add(item);
        }
