...
#pragma warning restore SYSLIB0011
                ...
                bool legacyMode)
            {
                ...
                {
                    // Couldn't parse for some reason, let the BinaryFormatter try to handle in the legacy API case.
                    if (legacyMode)
                    {
                    ...
                    // For example offset arrays -
                    // https://learn.microsoft.com/dotnet/api/system.array.createinstance?view=net-8.0#system-array-createinstance(system-type-system-int32()-system-int32())
