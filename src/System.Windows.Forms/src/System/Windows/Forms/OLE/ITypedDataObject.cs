...
///   data of the specified <see cref="Type"/> is exchanged.  When implementing a custom <see cref="IDataObject"/>
///   type, implement this interface as well.  Otherwise the APIs that specify a <see cref="Type"/> will throw
...
public interface ITypedDataObject
{
    ...
    /// <summary>
    ///  Retrieves data in a specified format, optionally converting the data to the specified format.
    /// </summary>
    /// <inheritdoc cref="TryGetData{T}(string, Func{TypeName, Type}, bool, out T) "/>
    bool TryGetData<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T>(
        string format,
    ...
    /// <summary>
    ///  <see cref="BinaryFormatter"/> compatible overload that retrieves typed data associated
    ...
    /// </param>
    /// <param name="data">
    ///  A data object with the data in the specified format, or null if the data is not
    ///  available in the specified format or is of a wrong type.
    /// </param>
    /// <returns>
    ...
    /// <remarks>
    ///  <para>
    ///   Implement this method for backward compatibility with binary formatted data
    ///   when binary formatters are enabled.
    ///  </para>
    /// </remarks>
    bool TryGetData<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T>(
        string format,
