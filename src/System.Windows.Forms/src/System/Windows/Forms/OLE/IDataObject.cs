...
///  <remarks>
///  <para>
///   When implementing a custom <see cref="IDataObject"/> type, implement <see cref="ITypedDataObject"/>
...
///   such as <see cref="Clipboard.TryGetData{T}(string, out T)"/>, will throw
