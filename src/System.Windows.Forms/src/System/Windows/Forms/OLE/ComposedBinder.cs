...
internal sealed class ComposedBinder : SerializationBinder
{
    ...
    public override Type? BindToType(string assemblyName, string typeName)
    {
        ...
        if (string.Equals(_typeName, typeName, StringComparison.OrdinalIgnoreCase)
            && string.Equals(_assemblyName, assemblyName, StringComparison.OrdinalIgnoreCase))
        {
            return _type;
        }

        // TanyaSo: Should we throw ArgumentException instead?
