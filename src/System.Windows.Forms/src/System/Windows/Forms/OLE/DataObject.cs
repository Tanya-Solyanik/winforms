    ...
    Com.IManagedWrapper<Com.IDataObject>
{
    ...
    /// <devdoc>
    ///  This resolver is used in deserialization of <see cref="Clipboard"/> content and when wrapped into a serialization binder, suppresses all dangerous types.
    /// </devdoc>
    ...
    /// <devdoc>
    ///  This resolver is used in deserialization of <see cref="Clipboard"/> content and when wrapped into a serialization binder, passes all types through.
    ///  It is used in compatibility scenarios when user explicitly opts into its use.
    /// </devdoc>
    // Nullability warning is suppressed because the application had explicitly opted into the unsafe compatible behavior.
