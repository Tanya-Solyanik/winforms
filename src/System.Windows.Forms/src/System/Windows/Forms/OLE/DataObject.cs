...
#pragma warning disable WFDEV006 // Type or member is obsolete
        GetData(DataFormats.WaveAudio, autoConvert: false) as Stream; // TanyaSo investigate if this is going through BF
...
#pragma warning disable WFDEV006 // Type or member is obsolete
        GetData(DataFormats.Bitmap, autoConvert: true) as Image;
#pragma warning restore WFDEV006
    ...
    public virtual string GetText(TextDataFormat format)
    {
        ...
        SourceGenerated.EnumValidator.Validate(format, nameof(format));
#pragma warning disable WFDEV006 // Type or member is obsolete
        return GetData(ConvertToDataFormats(format), false) is string text
#pragma warning restore WFDEV006
            ? text
            : string.Empty;
    }
