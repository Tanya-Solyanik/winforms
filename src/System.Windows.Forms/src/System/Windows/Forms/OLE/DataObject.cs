    ...
    Com.IManagedWrapper<Com.IDataObject>
{
    ...
    [Obsolete(
        ...
        error: false,
        DiagnosticId = Obsoletions.DataObjectGetDataDiagnosticId,
...
#pragma warning restore CS3001
    ...
    // [Obsolete(
    //    Obsoletions.DataObjectSetDataMessage,
    //    error: false,
    //    DiagnosticId = Obsoletions.DataObjectSetDataDiagnosticId,
    //    UrlFormat = Obsoletions.SharedUrlFormat)]
    // [EditorBrowsable(EditorBrowsableState.Never)]
    ...
    public virtual Stream? GetAudioStream() =>
        TryGetData(DataFormats.WaveAudio, out Stream? stream)? stream : null;
...
#pragma warning restore WFDEV006
    ...
    public virtual Image? GetImage() =>
        TryGetData(DataFormats.Bitmap, autoConvert: true, out Bitmap? bitmap) ? bitmap : null;
    ...
    public virtual string GetText(TextDataFormat format)
    {
        ...
        return TryGetData(ConvertToDataFormats(format), out string? text)
            ? text
            : string.Empty;
    }
