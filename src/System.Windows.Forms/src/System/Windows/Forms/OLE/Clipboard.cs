...
#pragma warning restore CS3001 // Argument type is not CLS-compliant
    ...
    private static bool TryGetDataInternal<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T>(
        string format,
        bool autoConvert,
        [NotNullWhen(true), MaybeNullWhen(false)] out T data)
    {
        ...
        if (GetDataObjectInternal(legacyCompatMode: false) is IDataObject dataObject)
        {
            ...
            return dataObject.TryGetData(format, NotSupportedResolver, autoConvert, out data);
        }
