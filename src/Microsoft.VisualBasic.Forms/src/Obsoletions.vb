...
Friend NotInheritable Class Obsoletions
    ...
    Friend Const ClipboardProxyGetDataMessage As String = "`ClipboardProxy.GetData(As String)` method is obsolete. Use `ClipboardProxy.TryGetData(Of T)(As T) ` instead."
    Friend Const ClipboardProxyGetDataDiagnosticId As String = "WFDEV007"
End Class
