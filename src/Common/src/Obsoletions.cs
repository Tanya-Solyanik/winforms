...
#pragma warning restore WFDEV003
    ...
    internal const string ClipboardProxyGetDataMessage = "`ClipboardProxy.GetData(As String)` method is obsolete. Use `ClipboardProxy.TryGetData(Of T)(As T) ` instead.";
    internal const string ClipboardProxyGetDataDiagnosticId = "WFDEV007";
}
